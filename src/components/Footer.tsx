  ...
  return (
    <footer className="border-t border-border">
      ...
      <div className="py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <a href="tel:+48506813729" className="font-body text-sm text-cream-dark hover:text-gold transition-colors">
                506 813 729
              </a>
            </div>
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <Mail size={14} className="text-gold flex-shrink-0" />
              <a href="mailto:michalec.grzegorz@wp.pl" className="font-body text-sm text-cream-dark hover:text-gold transition-colors">
        ...
        <p className="text-center font-body text-[10px] tracking-[0.3em] uppercase text-muted-foreground">
